...
******************************************************************************
Modification: Delete barrier inside the print function since section 0 will not
call this function so it will go on without waiting on this barrier. Then 
section 1 and 2 will wait here for 0 and get stuck here.
******************************************************************************/
#include <omp.h>
#include <stdio.h>
#include <stdlib.h>
